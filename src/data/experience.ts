...
export const experiences: ExperienceItem[] = [
  ...
  },
  {
    ...
    description: [
      ...
      'Trained new employees and taught them safety regulations, workplace standards, and use of machines and systems',
      'Collaborated with co-workers to maintain a positive team dynamic at 3 different store locations',
    ],
  },
  {
    ...
    description: [
      ...
      'Attended and participated in guest speakers presentations on SwiftUI, creating wireframes, and presentation skills',
